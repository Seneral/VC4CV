...
# Set mask parameters
ldi thresholdCO8, 0x66666666; # 0.4
ldi diffCO8, 0x33333333; # 0.2
ldi sh2, 16;
ldi sh3, 24;
...
sub lineIter, lineIter, r0; # Initiate line iterator (effectively rounding down)
;mov r0, 8;
...
:blockIter # Loop over blocks
	...
	.rep b, 5 # 5 Blocks of 32Bits each
		...
		.rep l, 4 # 4 Lines of 8Bits each
			...
			mov r0, sh2B;						shr r1, valReg(2,0), sh2B;
			v8adds r2, r2, diffCO8; 			shl r0, valReg(2,1), r0;
			v8min r2, r2, thresholdCO8; 		v8adds r0, r0, r1;
			v8subs minAccum, r2, r0;			v8min minReg(3,1), minReg(2,1), r4;
												v8min minReg(2,1), valReg(1,1), r4;

			# Write 0 to mask iff minAccum byte is 0 (can this be optimized?)
			max.setf r2, minAccum.8ai, 0;
			shl mskIter, mskIter, 1; v8adds.ifcc mskAccum, mskAccum, mskIter;
			max.setf r2, minAccum.8bi, 0;
			shl mskIter, mskIter, 1; v8adds.ifcc mskAccum, mskAccum, mskIter;
			max.setf r2, minAccum.8ci, 0;
			shl mskIter, mskIter, 1; v8adds.ifcc mskAccum, mskAccum, mskIter;
			max.setf r2, minAccum.8di, 0;
			shl mskIter, mskIter, 1; v8adds.ifcc mskAccum, mskAccum, mskIter;
			...
			# Compute mask for 4 pixels at once
			# 0 if value < min+diff and value < threshold
			mov r0, sh2B;						shr r1, valReg(2,1), sh2B;
			v8adds r2, r2, diffCO8; 			shl r0, valReg(2,2), r0;
			v8min r2, r2, thresholdCO8; 		v8adds r0, r0, r1;
			v8subs minAccum, r2, r0;			v8min minReg(3,2), minReg(2,2), r4;
